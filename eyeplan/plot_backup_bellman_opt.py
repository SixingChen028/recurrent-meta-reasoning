...
for jobid in range(NUM_JOBS):
    ...
    with open(os.path.join(exp_path, 'logger_backup_bellman_opt.pkl'), 'rb') as file:
...
ax.set_title('Optimistic Bellman', pad = 10)
...
plt.tight_layout()
# plt.show()
plt.savefig(os.path.join(exp_path, 'p_backup_heatmap_bellman_opt.pdf'), bbox_inches = 'tight')
...
plt.tight_layout()
# plt.show()
plt.savefig(os.path.join(exp_path, 'p_backup_grandpar_heatmap_bellman_opt.pdf'), bbox_inches = 'tight')
...
plt.tight_layout()
# plt.show()
plt.savefig(os.path.join(exp_path, 'p_backup_grandgrandpar_heatmap_bellman_opt.pdf'), bbox_inches = 'tight')