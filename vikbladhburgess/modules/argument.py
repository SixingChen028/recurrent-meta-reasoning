...
class ArgParser:
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--reward_point', type = float, default = 2., help = 'reward point')
        self.parser.add_argument('--default_point', type = float, default = -1., help = 'default point')
        self.parser.add_argument('--t_max', type = int, default = 30, help = 'max time steps per episode')
        self.parser.add_argument('--cost', type = float, default = 0.02, help = 'cost per action')
        self.parser.add_argument('--aux_cost', type = float, default = 0.1, help = 'auxiliary cost per action')
        ...
        self.parser.add_argument('--beta_e_init', type = float, default = 0.01, help = 'initial entropy regularization coefficient')
        self.parser.add_argument('--beta_e_final', type = float, default = 0.005, help = 'final entropy regularization coefficient')
