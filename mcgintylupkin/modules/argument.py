...
class ArgParser:
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--value_max', type = float, default = 5., help = 'max value')
        self.parser.add_argument('--value_mean', type = float, default = 3., help = 'value mean')
        self.parser.add_argument('--value_std', type = float, default = 1e5, help = 'value std')
        self.parser.add_argument('--reward_std', type = float, default = 5, help = 'std of reward observation')
