    ...
    for _ in range(num_trials):
        ...
        with torch.no_grad():
            ...
            while not done:
                ...
                # record fixation order
                if subsequent_fixations == None:
                    subsequent_fixations = [action, 1 - action, 1 - action]
                
                # force fixation
                else:
                    if len(subsequent_fixations) > 0:
                        action = subsequent_fixations.pop(0)
