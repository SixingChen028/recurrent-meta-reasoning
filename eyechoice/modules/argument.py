...
class ArgParser:
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--value_min', type = float, default = -10., help = 'min value')
        self.parser.add_argument('--value_max', type = float, default = 10., help = 'max value')
        self.parser.add_argument('--value_mean', type = float, default = 0.0, help = 'value mean')
        self.parser.add_argument('--value_std', type = float, default = 4.5, help = 'value std')
        ...
        self.parser.add_argument('--switch_cost', type = float, default = 0.025, help = 'switch cost')
